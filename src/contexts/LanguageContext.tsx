...
export type Language = "bn" | "en" | "ctg" | "noakhali" | "hi";
...
const translations: Record<Language, Record<string, string>> = {
  ...
  hi: {
    ...
    // App
    appName: "agriशक्ति",
    tagline: "मिट्टी, लोग, तकनीक – कृषि की नई शक्ति",
    taglineShort: "कृषि की नई शक्ति",
    beta: "बीटा",

    // Services
    diseaseDetection: "रोग पहचान",
    diseaseDesc: "फसल के रोग पहचानें",
    fertilizerScan: "उर्वरक स्कैन",
    fertilizerDesc: "उर्वरक जांचें",
    pestMap: "कीट मानचित्र",
    pestDesc: "क्षेत्र के कीट देखें",
    aiAssistant: "AI सहायक",
    aiDesc: "कृषि सलाह लें",
    marketPrice: "बाजार भाव",
    marketDesc: "बाजार मूल्य देखें",
    weather: "मौसम",
    weatherDesc: "मौसम पूर्वानुमान",
    satellite: "सैटेलाइट विजन",
    satelliteDesc: "NDVI मानचित्र देखें",
    calendar: "खेती कैलेंडर",
    calendarDesc: "कार्य समय-सारणी",
    calendarBanglaEng: "बांग्ला/अंग्रेजी कैलेंडर",
    compass: "कम्पास",
    compassDesc: "दिशा खोजक",
    landMap: "भूमि मानचित्र",
    landMapDesc: "सैटेलाइट मानचित्र",
    cropSchedule: "फसल समय-सारणी",
    machine: "मशीन ऑप्टिमाइज़र",
    machineDesc: "ट्रैक्टर/टिलर गाइड",
    npkCalculator: "उर्वरक कैलकुलेटर",
    npkDesc: "NPK खुराक गणना",
    climateAlert: "जलवायु चेतावनी",
    climateDesc: "आपदा चेतावनी",
    govServices: "सरकारी सेवाएं",
    govDesc: "सब्सिडी और ऋण",
    storage: "भंडारण प्रबंधन",
    storageDesc: "फसल भंडारण",
    history: "फसल इतिहास",
    historyDesc: "पिछले स्कैन देखें",
    rewards: "पुरस्कार",
    rewardsDesc: "बैज और अंक",
    fertilizerAdvice: "उर्वरक सलाह",
    fertAdviceDesc: "उर्वरक सिफारिशें",
    knowledge: "कृषि ज्ञान",
    knowledgeDesc: "सीखें और जानें",
    community: "समुदाय",
    communityDesc: "किसान समुदाय",
    appGuide: "ऐप गाइड",
    guideDesc: "ट्यूटोरियल देखें",
    landCalculator: "भूमि कैलकुलेटर",
    landDesc: "भूमि माप और मूल्य",
    impactAnalytics: "प्रभाव विश्लेषण",
    impactDesc: "समस्या समाधान चार्ट",
    cropBarter: "फसल विनिमय",
    barterDesc: "सीधा फसल विनिमय",
    demoScript: "डेमो स्क्रिप्ट",
    demoScriptDesc: "वीडियो स्क्रिप्ट",
    ...
    // Settings
    customizeApp: "अपना ऐप कस्टमाइज़ करें",
    language: "भाषा",
    bangla: "বাংলা",
    english: "English",
    chittagongian: "चटगांवी",
    noakhalian: "नोआखाली",
    notifications: "सूचनाएं",
    pushNotifications: "पुश सूचनाएं",
    weatherMarketUpdate: "मौसम और बाजार अपडेट",
    smsNotifications: "SMS सूचनाएं",
    importantAlerts: "महत्वपूर्ण चेतावनियां",
    namePhone: "नाम और फोन नंबर",
    privacy: "गोपनीयता",
    dataProtection: "डेटा सुरक्षा सेटिंग्स",
    help: "सहायता",
    faq: "सामान्य प्रश्न",
    aboutApp: "ऐप के बारे में",
    version: "संस्करण १.०.०",
    aiAssistantFull: "बांग्लादेश के किसानों के लिए AI सहायक",
    createdBy: "Created by TEAM_NEWBIES",
    selectLanguage: "भाषा चुनें",
    chooseLanguage: "अपनी पसंदीदा भाषा चुनें",
    enterPhone: "फोन नंबर दर्ज करें",
    phoneNumber: "फोन नंबर",
    smsSaved: "SMS सूचनाएं सक्रिय हो गईं",
    smsDisabled: "SMS सूचनाएं बंद हो गईं",
    languageChanged: "भाषा बदल गई",
    validPhone: "एक मान्य फोन नंबर दर्ज करें",
    smsDescription: "SMS सूचनाएं पाने के लिए अपना मोबाइल नंबर दर्ज करें",
    theme: "थीम",
    ...
    // Land Calculator
    landCalculatorTitle: "भूमि कैलकुलेटर",
    landCalculatorDesc: "भूमि माप और मूल्य की गणना करें",
    ...
    calculate: "गणना करें",
    result: "परिणाम",
    pricePerUnit: "प्रति इकाई मूल्य (रुपये)",
    ...
    offlineMessage: "इंटरनेट नहीं है। सीमित सुविधाएं उपलब्ध हैं।",

    // Chat
    askQuestion: "प्रश्न पूछें...",
    voiceInput: "वॉयस इनपुट",
    send: "भेजें",
    chatGreeting: "नमस्कार! मैं agriशक्ति AI हूं। आपकी कृषि समस्याओं में मदद के लिए तैयार हूं। आप क्या जानना चाहते हैं? 🌾",
    agriExpert: "कृषि विशेषज्ञ सहायक",
    suggestedQuestions: "सुझाए गए प्रश्न",
    justNow: "अभी",
    listening: "सुन रहे हैं...",
    speakBengali: "बोलें",
    typeOrSpeak: "टाइप करें या बोलें...",
    voiceHeard: "आवाज़ रिकॉर्ड हुई",
    voiceError: "वॉयस त्रुटि",
    chatHistoryCleared: "चैट इतिहास मिटा दिया गया",
    clearChatHistory: "चैट इतिहास मिटाएं",
    clickMicToSpeak: "बोलने के लिए माइक बटन पर क्लिक करें",
    sorryTempProblem: "क्षमा करें, अस्थायी समस्या हुई। कृपया पुनः प्रयास करें।",
    errorGettingAnswer: "उत्तर पाने में त्रुटि। कृपया पुनः प्रयास करें।",
    sorryCantAnswer: "क्षमा करें, उत्तर देने में असमर्थ।",
    listen: "सुनें",
    chatQuestion1: "धान की पत्तियां पीली क्यों हो रही हैं?",
    chatQuestion2: "उर्वरक कब डालना चाहिए?",
    chatQuestion3: "बारिश से फसल कैसे बचाएं?",
    chatQuestion4: "कीटों को कैसे नियंत्रित करें?",
    ...
    logoutError: "लॉगआउट में त्रुटि",
    accountCreated: "खाता सफलतापूर्वक बन गया!",
    fillAllFields: "कृपया सभी फ़ील्ड भरें",
    fillNameEmailPass: "कृपया नाम, ईमेल और पासवर्ड भरें",
    wrongEmailPass: "गलत ईमेल या पासवर्ड",
    emailAlreadyUsed: "यह ईमेल पहले से पंजीकृत है",
    ...
    // Weather Page
    weatherTitle: "मौसम",
    realTimeWeather: "रियल-टाइम मौसम",
    forecastTitle: "आगामी पूर्वानुमान",
    soilData: "मिट्टी डेटा",
    aiAdvice: "AI सलाह",
    moisture: "नमी",
    nitrogen: "नाइट्रोजन",
    medium: "मध्यम",
    soilRecommendation: "मिट्टी में नमी पर्याप्त है। सिंचाई की आवश्यकता नहीं।",
    today: "आज",
    tomorrow: "कल",
    dayAfter: "परसों",
    days3: "३ दिन",
    ...
    livePrice: "लाइव मूल्य अपडेट",
    loadingMarket: "बाजार भाव लोड हो रहे हैं...",
    aiSalesAdvice: "AI बिक्री सलाह",
    todayMarketPrice: "आज का बाजार भाव",
    marketLoadError: "बाजार भाव लोड करने में त्रुटि",
    waitSell: "बेचने के लिए रुकें",
    sellNow: "अभी बेचें",
    watchMarket: "बाजार पर नज़र रखें",
    priceUp: "मूल्य बढ़ने की संभावना",
    priceDown: "मूल्य घट सकता है",
    priceStable: "मूल्य स्थिर रहेगा",
    sell12Weeks: "१-२ सप्ताह में बेचें",
    urgent: "तत्काल",
    checkRegularly: "नियमित रूप से अपडेट देखें",
    confidence: "विश्वास",
    weekAvg: "सा. औसत",
    ...
    marketAnalysisText: "वर्तमान में धान और जूट की कीमतें बढ़ने की ओर हैं। सर्दियों में आलू की कीमतें स्वाभाविक रूप से घट सकती हैं। प्याज की कीमतें स्थिर रहने की उम्मीद है।",
    ...
    diseasesFound: "रोग पहचाने गए",
    totalXpEarned: "कुल XP अर्जित",
    activeDays: "सक्रिय दिन",
    scanHistory: "स्कैन इतिहास",
    myCalendar: "मेरा कैलेंडर",
    myCalendarDesc: "अपना कैलेंडर देखें",
    newFarmer: "नया किसान",
    farmer: "किसान",
    ...
    weAreHere: "हम आपके लिए यहां हैं",
    contactAnytime: "किसी भी समस्या के लिए हमसे संपर्क करें",
    emailSupport: "ईमेल सहायता",
    phoneSupport: "फोन सहायता",
    writeEmail: "हमें ईमेल करें, २४ घंटे में उत्तर पाएं",
    sendEmail: "ईमेल भेजें",
    callUs: "हमें कॉल करें",
    supportTime: "सुबह ९ - रात १०",
    everyday: "(हर दिन)",
    faqTitle: "सामान्य प्रश्न",
    faqScan: "रोग कैसे स्कैन करें?",
    faqScanAnswer: "स्कैनर बटन पर क्लिक करें और अपनी फसल की फोटो लें। AI स्वचालित रूप से रोगों का पता लगाएगा।",
    faqFertilizer: "उर्वरक कैलकुलेटर कैसे उपयोग करें?",
    faqFertilizerAnswer: "होमपेज से उर्वरक कैलकुलेटर पर जाएं, भूमि का आकार दर्ज करें और फसल चुनें।",
    faqFree: "खाता बनाने में पैसे लगते हैं?",
    faqFreeAnswer: "नहीं, agriशक्ति पूरी तरह से मुफ्त है।",
    ...
    // Camera Page
    aiScanner: "AI स्कैनर",
    uploadOrTakePhoto: "फसल की फोटो लें या अपलोड करें",
    takeClearPhoto: "फसल की पत्तियों की स्पष्ट फोटो लें",
    diseases100: "१००+ रोग",
    accuracy95: "९५% सटीक",
    withTreatment: "उपचार सहित",
    aiTip: "AI टिप",
    aiTipText: "पत्तियों की स्पष्ट फोटो लें। अच्छी रोशनी में ली गई फोटो से AI सटीक विश्लेषण कर सकता है।",
    takePhotoWithCamera: "कैमरे से फोटो लें",
    ...
    fertilizer: "उर्वरक",
    irrigation: "सिंचाई",
    recoveryDays: "ठीक होने के दिन",
    yieldImpact: "उपज पर प्रभाव",
    talkToAI: "अधिक के लिए AI से बात करें",
    newScan: "नया स्कैन",
    analyzedBy: "द्वारा विश्लेषित",
    critical: "गंभीर",
    high: "उच्च",
    ...
    cropHealthy: "फसल स्वस्थ है। कोई रोग नहीं मिला।",
    ...
    // HomePage specific
    services: "सेवाएं",
    aiDiseaseDiagnosis: "AI रोग निदान",
    takeCropPhotoAI: "फसल की फोटो लें, AI विश्लेषण करेगा",
    todayTipText: "बारिश की ६०% संभावना। सुबह सिंचाई करें, दोपहर में कीटनाशक का छिड़काव न करें। धान की पौध रोपण का सबसे अच्छा समय।",
    agricultureQuote: "\"कृषि सभ्यता की नींव है, और किसान राष्ट्र की रीढ़ हैं।\" — बंगबंधु शेख मुजीबुर रहमान",

    // Notification Center
    notificationCenter: "सूचना केंद्र",
    noNotifications: "कोई सूचना नहीं",
    noNotificationsDesc: "आपके पास अभी कोई नई सूचना नहीं है",
    markAllRead: "सभी पढ़े हुए चिह्नित करें",
    clearAll: "सभी साफ़ करें",
    newNotification: "नया",
    weatherAlertLabel: "मौसम चेतावनी",
    marketUpdateLabel: "बाजार अपडेट",
    farmingTipLabel: "खेती की सलाह",
